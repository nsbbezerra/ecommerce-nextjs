    ...
    <CenterLayourt>
      ...
      <Container id="fixed-menu">
        <Content>
          <ContentFixed>
            <Grid
              templateColumns={["1fr", "1fr", "1fr", "1fr", "280px 1fr"]}
              gap={10}
            >
              <Box display={["none", "none", "none", "none", "block"]}>
                ...
                <Box w="280px" borderWidth="1px" borderRadius="md" p={2}>
                  <Button
              ...
              <Box color={configs.template.productsPage.product.color}>
                ...
                >
                  ...
                  <IconButton
                    ...
                    fontSize="25px"
                    ml={2}
                    icon={menuOpen === false ? AiOutlineMenu : AiOutlineClose}
                    ...
                    >
                      ...
                      <Box pos="absolute" mt={-300} ml={2}>
                        ...
                        <Text
                          ...
                          fontWeight="600"
                          color={
                            configs.template.index.body.cards.cardsOffColor
                          }
                        >
                          -15%
                        </Text>
                      ...
                      <Box p={3}>
                        <Flex>
                          ...
                          <Text
                            ...
                            fontWeight="600"
                            color={
                              configs.template.index.body.cards.primaryColor
                            }
                          >
                            R$ 500,00
                          </Text>
